package com.example.shopping_mall.jwt;

import com.example.shopping_mall.entity.Member;
import com.example.shopping_mall.entity.RefreshToken;
import com.example.shopping_mall.entity.UserDetailsImpl;
import com.example.shopping_mall.repository.RefreshTokenRepository;
import com.example.shopping_mall.request.TokenDto;
import com.example.shopping_mall.response.ResponseDto;
import com.example.shopping_mall.shared.Authority;
...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 30 * 6;            //30분 * 6
